...
public class DiscordSettings
{
    ...
    public string BotGameStatus { get; set; } = "Klawf.Net: Pokémon";
    ...
    // Channels	
    [Category(Channels), Description("The only channels where the bot will acknowledge commands.")]
    public RemoteControlAccessList ChannelWhitelist { get; set; } = new();

    [Category(Channels), Description("Channels that will echo trade start messages.")]
    public RemoteControlAccessList TradeStartingChannels { get; set; } = new();

    [Category(Channels), Description("Channels that will echo announcements.")]
